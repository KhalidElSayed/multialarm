package com.alorma.multialarm.providers.base;
...
/**
 * This class implements a content provider with the ability to give orders to a
 * set of minion content providers <img
 * src="http://media.tumblr.com/tumblr_m3ncfqx4XX1qlo5lc.jpg" /> User: Sergi
 * Martínez Date: 24/01/13 Time: 23:25
 */
public abstract class DespicableContentProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		Cursor cursor = minion.query(getDb(), uri, projection, selection,
	...
	public int update(Uri uri, ContentValues values, String where,
		...
		MinionContentProvider minion = getMinion(uri);
		int rowsUpdated = minion.update(getDb(), uri, values, where,
				selectionArgs);
		getContext().getContentResolver().notifyChange(uri, null);
		return rowsUpdated;
	}
