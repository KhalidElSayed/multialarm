...
/**
 * Created with IntelliJ IDEA. User: Sergi Date: 24/01/13 Time: 23:19 To change
...
public interface MinionContentProvider {
	 ...
	 */
	public abstract long insert(SQLiteDatabase db, Uri uri,
	 ...
	 */
	public abstract int delete(SQLiteDatabase db, Uri uri, String where,
	 ...
	 * @return
	 */
	public abstract int update(SQLiteDatabase db, Uri uri,
